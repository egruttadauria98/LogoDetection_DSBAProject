...
test_record_fname = dataset.location + '/test/logo.tfrecord'
train_record_fname = dataset.location + '/train/logo.tfrecord'
label_map_pbtxt_fname = dataset.location + '/train/logo_label_map.pbtxt'
